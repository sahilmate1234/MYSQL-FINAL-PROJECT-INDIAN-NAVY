CREATE DATABASE IF NOT EXISTS indian_navy;
USE indian_navy;
-- =================================================================
-- Table 1: Personnel
...
-- display table data 
select* from sqodrons ;

-- to delete values from table 
truncate table sqodrons;
...
-- display table data 
select* from oprations;

-- to delete values from table 
truncate table oprations;

-- to delete table 
drop table oprations;
...
-- to delete values from table 
truncate table Personnel_Enlistment;

-- to delete table 
drop table Personnel_Enlistment;
-- =================================================================
...
-- to delete values from table 
truncate table Logistics_Supply;

-- to delete table 
drop table Logistics_Supply;
...
-- Insert records for cummunication_logs
...
-- display table data 
select* from CREATE DATABASE IF NOT EXISTS indian_navy;
USE indian_navy;
-- =================================================================
-- Table 1: Personnel
-- Description: Stores information about all naval personnel.
...
-- display table data 
select* from submarines;

-- to delete values from table 
truncate table submarines;

-- to delete table 
drop table submarines;
...
-- display table data 
select* from awards_and_honours;

-- to delete values from table 
truncate table awards_and_honours;

-- to delete table 
drop table awards_and_honours;
...
-- to delete values from table 
truncate table deployment_histroy;
...
-- display table data 
select* from assent_inventery;

-- to delete values from table 
truncate table assent_inventory;

-- to delete table 
drop table assent_inventory;
...
-- display table data 
select* from hydrographic_data;

-- to delete values from table 
truncate table hydrographic_data;

-- to delete table 
drop table hydrographic_data 
...
-- display table data 
select* from Command_Structure;

-- to delete values from table 
truncate table Command_Structure ;
